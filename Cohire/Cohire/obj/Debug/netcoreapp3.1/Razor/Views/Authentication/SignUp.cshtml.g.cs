#pragma checksum "C:\Users\Admin\Music\Cohire_New\Cohire\Views\Authentication\SignUp.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "31bac3695cbbff12ea7b5e63698e3f208d3639cf"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"31bac3695cbbff12ea7b5e63698e3f208d3639cf", @"/Views/Authentication/SignUp.cshtml")]
    ...
    public class Views_Authentication_SignUp : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#nullable restore
#line 6 "C:\Users\Admin\Music\Cohire_New\Cohire\Views\Authentication\SignUp.cshtml"
 if (ViewBag.ID == "L")
{
...
#nullable restore
#line 43 "C:\Users\Admin\Music\Cohire_New\Cohire\Views\Authentication\SignUp.cshtml"
              }
            else
            {
...
#nullable disable
            WriteLiteral("                ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "31bac3695cbbff12ea7b5e63698e3f208d3639cf6285", async() => {
                WriteLiteral(@"
                    <table>
                        <tr>
            ...
            WriteLiteral("\r\n");
#nullable restore
#line 62 "C:\Users\Admin\Music\Cohire_New\Cohire\Views\Authentication\SignUp.cshtml"
            }
...
<script>
    function VerifySignUp() {
        ...
        if ($(""#password"").val() != $(""#cpassword"").val()) {
            $(""#cpassword_err"").html(""P");
            WriteLiteral(@"assword does not match""); Is_error = 1;
        } else {
            $(""#cpassword_err"").html("""");
        }
        if (Is_error == 0) {
     ...
     ");
            WriteLiteral(@"                   alert(resultData.errormsg);
                    } else {
        ...
        $.ajax({
            ...
            success: function (resultData) {
                ...
                if (resultData.is_error == true) {
                    ...
                    if (Is_email == true) {
                        $(""#otp_confirm"").html(""Otp has bee");
            WriteLiteral(@"n sent to your email"");
                    }
                    if (Is_mobile == true) {
